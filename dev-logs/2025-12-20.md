...
> Watch the video here: [https://youtu.be/AuVHb8rOYpQ](https://youtu.be/AuVHb8rOYpQ)

## Agenda

- [x] Refactor multiple aspects of the game
- [x] Create `game.rs` module to handle aspects of the game such as initial deal, new game, determine winner, etc.
- [x] Refine modified `Display` trait
- [x] Start learning and practicing ownership concepts
- [x] Practice professional documentation techniques for modules, structs, and implications
